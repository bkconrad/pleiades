...
class LevelsController extends AppController {
	...
	function _performUpload() {
		...
		if(isset($this->request->data['Level']['screenshot'])) {
			$this->_getScreenshot($this->request->data['Level']['screenshot']);
		}
	...
	function _getUploadFilename($field) {
	...
	public function edit($id = null) {
		...
		if($this->request->is('post') || $this->request->is('put')) {
			...
			if(!empty($this->request->data['Level']['screenshot']['tmp_name'])) {
				if(!$this->_getScreenshot($this->request->data['Level']['screenshot'])) {
	...
	public function massupload() {
		if($this->request->is('post')) {
			$filename = $this->_getUploadFilename('zipFile');
